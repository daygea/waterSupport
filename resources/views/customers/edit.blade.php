                   ...
                   <center> @include('includes.flash') </center>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/edit_customer') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input autocomplete="off" id="name" type="text" class="form-control typeahead" name="name" value="{{ $customer->name }}">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input autocomplete="off" id="phone" type="text" class="form-control" name="phone" value="{{ $customer->phone }}">
                            ...
                            <div class="col-md-6">
                                <select id="category" type="category" class="form-control" name="category" value="{{ old('category') }}">
                                    ...
                                    @foreach ($categories as $category)
                                        ...
                                        <option value="{{ $category->id }}" {{ $category->id == $customer->zone ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="5" id="message" class="form-control" name="message">{{ $customer->address }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> Update Customer
                                </button>
                            </div>
                        </div>
                    </form>
