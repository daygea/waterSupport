		...
		<div class="col-md-10 col-md-offset-1">
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                ...
	                <form class="form-horizontal" role="form" method="POST" action="{{ url('/new_product') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="title" autocomplete="off" type="text" class="form-control" name="title" value="{{ old('title') }}">
                        ...
                        <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="qty" autocomplete="off" type="number" class="form-control" name="qty" value="{{ old('qty') }}">
                        ...
                        <div class="form-group{{ $errors->has('unit_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="unit_price" type="number" class="form-control" name="unit_price" value="{{ old('unit_price') }}">
                        ...
                        <div class="form-group{{ $errors->has('reduced_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="reduced_price" type="number" class="form-control" name="reduced_price" value="{{ old('reduced_price') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-ticket"></i> Create Product
                                </button>
                            </div>
                        </div>
                    </form>
